...
<div  id="main" role="main">
    ...
    <article class="post" itemscope itemtype="http://schema.org/BlogPosting">
        <h2 class="post-title" itemprop="name headline" style="margin-left:28px">
            <a itemtype="url" href="<?php echo $item->resolved_url ?>" target="_blank"><?php echo $item->resolved_title ?></a>
        </h2>

        <ul class="post-meta">
            <li style="margin-left:28px;">时间: <time datetime="<?php echo date('Y-m-d H:i:s', $item->time_added) ?>" itemprop="datePublished"><?php echo date('Y-m-d H:i:s', $item->time_added) ?></time></li>
        </ul>

        <div class="post-content" itemprop="articleBody" style="margin-left:16px;">
