    ...
    <header>
        ...
        <ul class="nav nav-list">
            <li class="nav-list-item"><a href="<?php $this->options->siteUrl(); ?>"
                                         class="nav-list-link <?php if ($this->is('index')) echo 'active'; ?>">博客</a>
            </li>
            <li class="nav-list-item"><a href="<?php $this->options->siteUrl('archives.html'); ?>"
                                         class="nav-list-link <?php if ($this->is('page', 'archives')) echo 'active'; ?>">归档</a>
            </li>
            <li class="nav-list-item"><a href="<?php $this->options->siteUrl('about.html'); ?>"
                                         class="nav-list-link <?php if ($this->is('page', 'about')) echo 'active'; ?>">关于</a>
            </li>
            <li class="nav-list-item"><a href="<?php $this->options->siteUrl('links.html'); ?>"
                                         class="nav-list-link <?php if ($this->is('page', 'links')) echo 'active'; ?>">友情链接</a>
            </li>
            <li class="nav-list-item"><a href="<?php $this->options->siteUrl('guestbook.html'); ?>"
										 class="nav-list-link <?php if ($this->is('page', 'guestbook')) echo 'active'; ?>">给我留言</a>
			</li>
        </ul>
    </header>
