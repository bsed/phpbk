	...
	<div class="blog-banner">
		...
		<div class="blog-banner-text">
			...
			<ul class="post-meta">
				...
				<li><a><i class="fa fa-eye"></i> <?php Views_Plugin::theViews(); ?></a></li>
				<li><a class="btn-like" data-cid="<?php $blogBanner->cid(); ?>"><i class="fa fa-thumbs-up"></i> <span class="post-like-num"><?php $this->likesNum(); ?></span></a></li>
	...
	<?php $i=1;$tag=""; while($this->next()): ?>
        ...
        <article class="post" itemscope itemtype="http://schema.org/BlogPosting">
			...
			<div class="post-body<?php echo $tag; ?>">
				<!-- 无图片随即颜色 -->
				<?php else:?>
				<div class="post-body post-text" style="background-color:#F6F6F8">
				<?php endif;?>
					<!-- 分类 -->
