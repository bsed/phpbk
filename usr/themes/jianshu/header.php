...
<head <?php echo $screen_mode;?>>
    ...
    <link rel="icon" href="<?php  $this->options->themeUrl('favicon.ico'); ?>" type="image/gif">
    ...
    <?php endif; ?>
	<script type="text/javascript" src="https://dn-imgpic.qbox.me/libs/jquery/1.11.1/jquery.min.js"></script>
