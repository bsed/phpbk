...
function themeConfig($form) {
    ...
    $duosuojs = new Typecho_Widget_Helper_Form_Element_Text('duosuojs', NULL, '//static.duoshuo.com/embed.js', _t('多说评论框JS'), _t('多说评论框embed.js路径，可用于embed.<font color="#F40">注意：支持HTTPS，路径不必填写https:或http:</font>'));
    $form->addInput($duosuojs);

    $css = new Typecho_Widget_Helper_Form_Element_Radio('css',
        array(
          'default' => _t('<span style="display: inline-block; width: 24px; height: 15px; background-color:#e78170; -webkit-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; -moz-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset;"></span><font color="#e78170">默认风格</font>'),
          'red' => _t('<span style="display: inline-block; width: 24px; height: 15px; background-color:#DA4453; -webkit-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; -moz-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset;"></span><font color="#DA4453">红色风格</font>'),
          'green' => _t('<span style="display: inline-block; width: 24px; height: 15px; background-color:#8CC152; -webkit-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; -moz-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset;"></span><font color="#8CC152">绿色风格</font>'),
          'blue' => _t('<span style="display: inline-block; width: 24px; height: 15px; background-color:#4A89DC; -webkit-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; -moz-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset;"></span><font color="#4A89DC">蓝色风格</font>'),
          'purple' => _t('<span style="display: inline-block; width: 24px; height: 15px; background-color:#967ADC; -webkit-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; -moz-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset;"></span><font color="#967ADC">紫色风格</font>'),
          'black' => _t('<span style="display: inline-block; width: 24px; height: 15px; background-color:#434A54; -webkit-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; -moz-box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.3) inset;"></span><font color="#434A54">黑色风格</font>')),
          'default',
          	_t('配色风格'));
    ...
    $alipayAmount = new Typecho_Widget_Helper_Form_Element_Text('alipayAmount', NULL, '10', _t('默认打赏金额'), _t('在这里填入打赏金额'));
...
function parseContent($obj){
    ...
    if (!empty($options->lightbox) && '1' == $options->lightbox){
 ...
 * @return void
 */
function PageToLinks($slug = 'links', $tag = 'h2', $listTag = 'ul')
{
    /** 获取数据库支持 */
    $db = Typecho_Db::get();
