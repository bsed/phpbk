...
<div class="main-container">
    ...
    <div class="post-author clearfix">
      <?php if ($this->options->post_author == '1'): ?>
      ...
      <?php endif; ?>
      <?php if ($this->options->post_author == '2'): ?>
      <a class="fl" href="<?php $this->author->permalink(); ?>" title="<?php $this->author(); ?>"><img class="post-avatar" width="32" src="<?php echo gravatarUrl($this->author->mail,32); ?>" alt="" /></a>
      <?php endif; ?>
      <?php _e('由');?>
    ...
    <?php endif; ?>
        ...
        <ul class="post-meta clearfix">
            ...
            <li href="<?php $this->permalink() ?>#comments" class="ds-thread-count" data-thread-key="<?php $this->cid(); ?>"></a><li>
            <?php endif; ?>
