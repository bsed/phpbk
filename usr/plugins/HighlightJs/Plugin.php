...
class HighlightJs_Plugin implements Typecho_Plugin_Interface {
    ...
    public static function header() {
        $style = Helper::options()->plugin('HighlightJs')->code_style;
        $cssUrl = Helper::options()->pluginUrl . '/HighlightJs/markdown/styles/' . $style;
    ...
    public static function footer() {
        $jsUrl = Helper::options()->pluginUrl . '/HighlightJs/markdown/highlight.pack.js';
        echo <<<HTML
