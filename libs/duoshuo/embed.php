...
if(($data = file_get_contents("http://static.duoshuo.com/embed.js", 0, $timeout)) == NULL) {
	...
	$data = str_replace("e.avatar_url","'https://yigrherb.com/libs/duoshuo/img-cache.php?src='+e.avatar_url",$data);
	$data = str_replace("nt.data.default_avatar_url","'https://yigrherb.com/libs/duoshuo/img-cache.php?src='+nt.data.default_avatar_url",$data);
	echo $data;
}
