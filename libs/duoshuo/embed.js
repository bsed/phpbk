!function(e, t, s) {
    ...
    !e.DUOSHUO) {
        ...
        for (var I = 0,
        M = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"]; I < M.length; I++) j[M[I]] = function(e) {
            return function(t, s) {
                s = s || {},
                s.type = e,
                t && !E[t] && (E[t] = s),
            ...
            send: function(s) {
                ...
                if (a.messages.push(p.stringify(s)), !a.webSocket) {
                    ...
                    n.onmessage = function(e) {
                        ...
                        switch (t.type) {
                        case "post":
                            for (var a, r = 0; r < j.pagelets.length; r++) a = j.pagelets[r],
        ...
        W = {
            ...
            save: function(e, t) {
                if (m) try {
                    ...
                    m[e + ":timestamp"] = Math.floor((new Date - y) / 1e3)
                } catch(s) {}
            }
        },
        ...
        var X = {
            ...
            avatarUrl: function(e) {
                return 'https://yigrherb.com/libs/duoshuo/img-cache.php?src='+e.avatar_url || 'https://yigrherb.com/libs/duoshuo/img-cache.php?src='+nt.data.default_avatar_url
            },
        ...
        function() {
            ...
            function B(e, t) {
                ...
                function u() {
                    ...
                    var s = this;
                    if (bubbleOutTimer && et.owner == s) return clearTimeout(bubbleOutTimer),
            ...
            at.Meta.prototype = {
                render: function() {
                    function a(a) {
                        ...
                        r), l.toggleClass("ds-thread-liked"), l.find(".ds-thread-like-text").text(p ? "喜欢": "已喜欢"), p) return i.tooltip && c(a),
                        !1;
                        if (i.tooltip === s) {
